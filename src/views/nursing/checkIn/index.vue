<template>
  <div class="app-container">
    ...
    <el-table v-loading="loading" :data="checkInList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="老人姓名" align="center" prop="elderName" fixed="left" width="150" />
      <el-table-column label="身份证号" align="center" prop="idCardNum" width="200" />
      ...
      <el-table-column label="入住期限" align="center" prop="startDate" width="200">
