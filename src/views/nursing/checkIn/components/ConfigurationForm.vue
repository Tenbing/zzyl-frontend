<template>
    <div class="info">
        ...
        <el-row gutter="15">
            ...
            <el-col :span="12">
                <el-form-item label="政府补贴" prop="governmentPayment">
                    <el-input-number :disabled="type === 'read'" v-model="formData.governmentPayment" placeholder="政府补贴"></el-input-number>
                </el-form-item>
            </el-col>
...
watch(
  ...
  () => {
        formData.value = {
            ...props.configInfo,
            governmentPayment: props.configInfo.governmentPayment ?? props.configInfo.governmentSubsidy ?? 0,
        };
