            ...
            <el-col :span="12">
                <el-form-item label="身份证号" prop="idCardNo">
                    <el-input v-model="formData.idCardNo" type="text" :readonly="type === 'read'" placeholder="请输入身份证号" clearable
                        :style="{ width: '100%' }" @change="handleIdCardNoChange"></el-input>
                </el-form-item>
            </el-col>
        ...
        <el-row gutter="15">
            <el-col :span="12">
                <el-form-item label="性别" prop="gender">
                    <el-radio-group v-model="formData.gender" :readonly="type == 'read'" size="default">
...
watch(props,()=>{
    const info = { ...props.applyFormInfo }
    if (info.gender === undefined && info.sex !== undefined) {
...
// 根据身份证号自动填充出生日期和年龄
function handleIdCardNoChange(val) {
